...
Use this workflow to review normalized VoiceNotes notes and recommend the next step.
...
6. If several notes point to a new theme, run `python3 scripts/voice_notes.py discover`.
