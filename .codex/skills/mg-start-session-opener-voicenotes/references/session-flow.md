...
1. `python3 scripts/voice_notes.py status`
...
- Review one packet:
  - `python3 scripts/voice_notes.py review --note-id <source_note_id>`
- Rebuild one compiled package:
  - `python3 scripts/voice_notes.py compile --note-id <source_note_id>`
- Record a decision:
  - `python3 scripts/voice_notes.py decide --note-id <source_note_id> --decision approve`
  - `python3 scripts/voice_notes.py decide --note-id <source_note_id> --decision pending-project --thread-id <thread_id> --continuation-of <source_note_id>`
- Dispatch only after explicit confirmation and explicit note IDs:
  - `python3 scripts/voice_notes.py dispatch --confirm-user-approval --note-id <source_note_id>`
