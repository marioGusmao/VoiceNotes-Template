...
Use this skill at the start of a session in the VoiceNotes triage hub. It establishes the safe operating sequence for the repository and keeps the session focused on review, approval, and rule refinement rather than premature dispatch.
